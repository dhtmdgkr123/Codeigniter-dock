<body>
    <div id="container">
        ...
        <div id="body">
            ...
            <p>And this app is install By composer</p>
            <p>Based on kenjis/codeigniter-composer-installer</p>
            <p>composer autoloader is already loaded in index.php</p>
            <p>Dependency : Dotenv</p>
            <strong>customize : dhtmdgkr123</strong>

            <p>If you would like to edit this page you'll find it located at:</p>
            <code>application/views/Login/head.php</code>
            <code>application/views/Login/body.php</code>
            <code>application/views/Login/footer.php</code>
            ...
            <ul>
                <li>
                    <code>application/libraries/Json.php</code>
                    <ul>
                        <li>
                            <p>response json encoding only array</p>
                            <code>$this->json->echo(['key' => 'value'])</code>
                        </li>
                    </ul>
                </li>
                <li>
                    <code>application/libraries/File.php</code>
                    <ul>
                        <li>
                            <p>check View file is exists</p>
                            <pre>
if ($this->file->checkView('Login/head', 'Login/body', 'Login/footer')) {
    // application/views/Login/head.php and
    // application/views/Login/body.php and
    // application/views/Login/footer.php is exists in checkView method
    ...
    show_404();
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <p>generate php migrate template</p>
                            <code>$ php index.php Migrate generate MigrationName</code>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <p>If you are exploring CodeIgniter for the very first time, you should start by reading the <a
                    href="https://codeigniter.com/user_guide/index.html">User Guide</a>.</p>
